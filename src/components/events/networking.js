...
export default class Networking extends Component {
 constructor(props) {
    ...
    componentWillMount() {
        axios
            .get(API_DOMAIN + "/api/events/?type=networkingevents")
            .then(res => {
                    ...
                    <Row className="clearfix">
                        <Col sm={4} className="side-workshop">
                            <Nav bsStyle="pills" stacked className="ledge">
                                <NavItem eventKey="first" className="know" href="javascript: void(0)">{this.state.events[2].title}</NavItem>
                                <NavItem eventKey="second" className="know" href="javascript: void(0)">{this.state.events[1].title}</NavItem>
                                <NavItem eventKey="3" className="know" href="javascript: void(0)">{this.state.events[0].title}</NavItem>
                            </Nav>
                        </Col>
                        <Col sm={8}>
                            <Tab.Content animation>
                                <Tab.Pane eventKey="first">
                                    ...
                                    <div className="view">Registeration Opening Soon</div>
                                </Tab.Pane>
